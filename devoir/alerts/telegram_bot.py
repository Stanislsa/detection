...
class TelegramBot:
    ...
    - Envoi d'images (squelette, thumbnail)
    ...
    def __init__(self):
        ...
        self.min_alert_interval = 60.0  # 1 minute entre les alertes
        
        # Templates de messages
        self.message_templates = {
            "fall_alert": self._template_fall_alert,
            "fall_confirmed": self._template_fall_confirmed,
...
# Fonction utilitaire pour l'envoi d'alerte
async def send_telegram_alert(
    ...
    """
    Fonction utilitaire pour envoyer une alerte Telegram.
    ...
    async with TelegramBot() as bot:
        return await bot.send_fall_alert(
            person_name=person_name,
            gravity_level=gravity_level,
            gravity_score=gravity_score,
            location=location,
